...
function v_spawnProjectileSpread(args, board)
  if args.projectileCount == nil then
    sb.logWarn("v_spawnProjectileSpread: args.projectileCount not defined")
    return false
  end
  
  if args.projectileType == nil then
    sb.logWarn("v_spawnProjectileSpread: args.projectileType not defined")
    return false
  end
  
  if args.spreadAngle == nil then
    sb.logWarn("v_spawnProjectileSpread: args.spreadAngle not defined")
    return false
  end
  
  if args.sourceEntity == nil then
    sb.logWarn("v_spawnProjectileSpread: args.sourceEntity not defined")
    return false
  end
  
  if args.position == nil then
    sb.logWarn("v_spawnProjectileSpread: args.position not defined")
    return false
  end
  ...
  if args.offset == nil then
    sb.logWarn("v_spawnProjectileSpread: args.offset not defined")
    return false
  end
  
  if args.angledOffset == nil then
    sb.logWarn("v_spawnProjectileSpread: args.angledOffset not defined")
    return false
  end
  
  if args.aimVector == nil then
    sb.logWarn("v_spawnProjectileSpread: args.aimVector not defined")
    return false
  end
