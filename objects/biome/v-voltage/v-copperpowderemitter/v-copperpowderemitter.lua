...
-- TODO prevent it from flooding the game with entities at really high emission rates.

function init()
  emitterSpecs = config.getParameter("windParticleEmitter")
...
function emitParticle()
  ...
  world.spawnProjectile("orbitalup", ownPosition, entity.id(), {0, 0}, false, {
    timeToLive = 0,
    onlyHitTerrain = true,
    actionOnReap = {
      {
