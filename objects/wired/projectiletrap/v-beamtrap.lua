...
--[[
  *sigh*
  This script is necessary because Chucklefish decided to use magic numbers for the width of the damage area of the 
  beam.
]]
...
function init()
  ...
  self.beamWidth = config.getParameter("beamWidth", 1.0) / 2
...
function setBeamDamage(startProjectile, endProjectile)
  ...
  local damagePoly = {{0, -self.beamWidth}, {0, self.beamWidth}, {length, self.beamWidth}, {length, -self.beamWidth}}
