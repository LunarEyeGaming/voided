...
function init()
  ...
  isActive = config.getParameter("v-riftZoneDetectorIsActive")
  baseIcon = config.getParameter("baseIcon")
  animator.setAnimationState("detector", isActive and "on" or "off")
end
...
function toggle()
  ...
  activeItem.setInstanceValue("v-riftZoneDetectorIsActive", isActive)
