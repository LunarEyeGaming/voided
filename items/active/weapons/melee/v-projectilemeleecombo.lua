...
function ProjectileMeleeCombo:init()
  self.comboStep = 1
...
function ProjectileMeleeCombo:update(dt, fireMode, shiftHeld)
...
-- State: windup
function ProjectileMeleeCombo:windup()
...
function ProjectileMeleeCombo:wait()
...
function ProjectileMeleeCombo:preslash()
...
-- State: fire
function ProjectileMeleeCombo:fire()
...
function ProjectileMeleeCombo:shouldActivate()
...
function ProjectileMeleeCombo:readyFlash()
  animator.setGlobalTag("bladeDirectives", self.flashDirectives)
  self.flashTimer = self.flashTime
end

function ProjectileMeleeCombo:computeDamageAndCooldowns()
  local attackTimes = {}
...
function ProjectileMeleeCombo:leveledDamage(damage)
